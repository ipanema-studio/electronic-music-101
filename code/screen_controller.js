...
function screen_aboutus() {
	hide_all();
	messnamed(screen_mess[21], 0);
	messnamed("hide_main_title", 1);
}

function screen_workstation() {
	hide_all();
	messnamed(screen_mess[1], 0);
	messnamed("hide_main_title", 1);
}
...
function screen_layering() {
	hide_all();
	messnamed(screen_mess[19], 0);
	messnamed("title", "Layering");
}

function screen_composition() {
	hide_all();
	messnamed(screen_mess[20], 0);
	messnamed("title", "Composition");
}